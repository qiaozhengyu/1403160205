...
DrawWidget::DrawWidget(QWidget *parent) : QWidget(parent)
{
    ...
    setMinimumSize (800, 800);      //设置绘制区窗体的最小尺寸
...
//绘图
void DrawWidget::drawpicture()
{

    QString file_Name;  //获取文件路径
    file_Name = QFileDialog::getOpenFileName(this,tr("选择图片"), ".",tr("Image Files (*.png *.jpg *.bmp)"));


    if(file_Name.isEmpty())
    {
        QMessageBox message;
        message.warning(this,"警告","未选择图片，是否退出!");
        return;
    }
    //绘制选择的图片
    pix->load(file_Name);
